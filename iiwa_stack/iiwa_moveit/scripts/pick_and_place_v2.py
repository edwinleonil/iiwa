...
def get_current_pose():
    current_pose = move_group.get_current_pose(end_effector_link="iiwa_link_ee")
...
def get_current_rpy():
    roll_pitch_yaw = move_group.get_current_rpy(end_effector_link="iiwa_link_ee")
...
def set_pose_target_01():
    ...
    move_group.set_pose_target(
        target_pose, end_effector_link="tool_link_ee")
